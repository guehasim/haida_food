...
<body>
   <div class="page">
        ...
        <header>
            ...
            <div>
                <h2>PT. HAIDA AGRICULTURE INDONESIA</h2>
            </div>
        </header>
        <div class="lineinvoice">
            <div>
                <h2>LAPORAN Check In Canteen / 入住食堂</h2>
            </div>
        </div>
            ...
            <table class="table" style="max-width: 250px;">
                <tbody>
                    <tr>
                        ...
                        <?php
                        if ($period_awal == '1970-01-01') {
                             $awal  = '';
                             $akhir = date('d M y',strtotime($period_akhir));
                         }else if($period_akhir == '1970-01-01'){
                            $awal   = date('d M y',strtotime($period_awal));
                            $akhir  = date('d M y');
                         }else{
                            $awal   = '';
                            $akhir  = date('d M y');
                         ...
                         ?>
                        <td style="border: 0px;text-align: left;"> : <?php echo $awal;?> S.D. <?php echo $akhir;?></td>
                    </tr>
                </tbody>
            </table>
            <br />
            <table class="table table-striped table-bordered" cellpadding="2" cellspacing="0" style="">
                <thead>
                    <tr style="background:#dadade;">
                        ...
                        <th style="padding: 5px; border: 1px solid black;">Tanggal / Jam</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;"><?php echo date('d M y',strtotime($ad->TglTrans));?> / <?php echo date('H : i : s',strtotime($ad->JamTrans));?></td>
                        <td style="text-align:left;"><?php echo $ad->NikUser;?></td>
                        <td style="text-align:left;"><?php echo $ad->NamaUser;?></td>
                        <td style="text-align:left;"><?php echo $ad->DeptUser;?></td>
                    </tr>    
                    <?php endforeach ?>
                </tbody>
            </table>
