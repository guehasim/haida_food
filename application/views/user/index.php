                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#ganti-info-<?php echo $ad->ID_User;?>"><li class="fas fa-lock"></li> Ganti Password</button>
