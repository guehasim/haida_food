	...
	<h1>Check In Canteen / 入住食堂</h1>
		<div class="container" style="padding: 0px 0px 0px 150px;">
			...
			<div style=" width: 90%;">
				<div>
					<table>
						<tr style="color: white; font-size: 30px;font-weight: bold;">
							<td><?php echo date('d M Y');?></td>
							<td>|</td>
							<td><span class="badge bg-success" id="jam"></span></td>
							<td>:</td>
							<td><span class="badge bg-info" id="menit"></span></td>
							<td>:</td>
							<td><span class="badge bg-danger" id="detik"></span></td>
						</tr>
					</table>
				</div>
			</div>
